...
const BUY_URL = 'https://buy.polar.sh/polar_cl_HkduVIVNm8Az4pn2Kb4lT1WFFZg1LPla2OKZ53TlbaL';
const SLUG = 'ai-act-article-50-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '3ec22495-be74-4456-82a1-a048d7872fdd';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
