...
const BUY_URL = 'https://buy.polar.sh/polar_cl_YK2CXL7Hd4TEoxQ76oOVQpVAsrLK9zUpcK7oV2MKwJs';
const SLUG = 'jdk25-upgrade-blocker-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'ecc7be06-5c7b-418a-abf2-9204bdc20568';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
