...
const BUY_URL = 'https://buy.polar.sh/polar_cl_zWR0ONLtSMG7LQI0QRnUpBYLlnvyyGNDbppZ81dtUFN';
const SLUG = 'runtime-eol-deploy-block-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'f583432e-710c-4d36-9959-cc0e382461de';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
