...
const BUY_URL = 'https://buy.polar.sh/polar_cl_6xgUWpQ6iaKfxXsoisZTLdijmkHV4QNSr4Jh70yIPHM';
const SLUG = 'dsfinv-k-export-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '8d158af3-74f9-4a16-9517-3e4b4eaf3c44';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
