...
const BUY_URL = 'https://buy.polar.sh/polar_cl_hzMmPTuPiEAYRuvwu8YSBx7gsDb2vpkq83FFK4LJ6ke';
const SLUG = 'ingress-nginx-retirement-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'a381d2e8-1173-42b2-be02-54e7d1015daf';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
