...
var CENTRALREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = CENTRALREPORT;
else window.CENTRALREPORT = CENTRALREPORT;
