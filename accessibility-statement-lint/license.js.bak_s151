...
const BUY_URL = 'https://buy.polar.sh/polar_cl_DPpapwyFI9vWmYeB4f49Fp7BoXUo3CEvxfWmn16zHsc';
const SLUG = 'accessibility-statement-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '9030277a-6807-46eb-a794-07237aa6fcd5';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
