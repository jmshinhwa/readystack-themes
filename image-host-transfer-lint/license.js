...
const BUY_URL = 'https://buy.polar.sh/polar_cl_CizB7BOiQnrCD9uAsBxpds5fDtpbi0BD1xPKa3GqTUD';
const SLUG = 'image-host-transfer-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '4f2685a0-89c3-4b2d-9dce-9c500ba3f664';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
