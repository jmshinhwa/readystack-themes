...
const BUY_URL = 'https://buy.polar.sh/polar_cl_DxnwX3BvMThBo4369WHczw3OVdSlhjnkHsoJb0ZEGWd';
const SLUG = 'security-headers-csp-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '1f6d97e0-c893-40bc-9485-73e21f014509';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
