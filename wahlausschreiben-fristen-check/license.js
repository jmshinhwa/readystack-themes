...
const BUY_URL = 'https://buy.polar.sh/polar_cl_4SEro9hA8nfEdiXqenQRjTT3DTqjHtqdlCfpw4OP17i';
const SLUG = 'wahlausschreiben-fristen-check';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '51af162e-22ba-4fdf-ae51-c92e608cd2a7';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
