...
const BUY_URL = 'https://buy.polar.sh/polar_cl_fZrQG7uhuskOPgS9ehe9WtzEYhgvYwc7wmHCT0UgLaX';
const SLUG = 'canal-de-denuncias-lint-es';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '9c2518ef-5de9-45b8-b747-143aab7a6792';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
