...
var MCP_AUDIT_REPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = MCP_AUDIT_REPORT;
else window.MCP_AUDIT_REPORT = MCP_AUDIT_REPORT;
