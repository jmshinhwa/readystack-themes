...
const BUY_URL = 'https://buy.polar.sh/polar_cl_rvApWbLcqMhAIqiOEhiXEf2qoShcoNxkA0AXm2wPzPw';
const SLUG = 'config-dsl-lint-snippet-pack';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '5308a1e3-e951-436b-8f99-ef9c890a9601';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
