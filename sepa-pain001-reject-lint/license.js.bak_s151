...
const BUY_URL = 'https://buy.polar.sh/polar_cl_N7N2pi0j0uaHYYPZtOCrLH26cW16sblDpl47O3DkN9X';
const SLUG = 'sepa-pain001-reject-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '6d1a97a4-2d67-4e2f-b6ec-f452c0084e64';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
