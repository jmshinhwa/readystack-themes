...
const BUY_URL = 'https://buy.polar.sh/polar_cl_qJoSHN0MM1nBgb9WtR2jW9kBTNvjLxyfKL1hP0NGwfK';
const SLUG = 'proto-wire-break-check';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'a9638959-3b94-4680-b057-3c6fefee0c97';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
