...
const BUY_URL = 'https://buy.polar.sh/polar_cl_ZRgsG5E9wpjfw710CyEFUGgArfwIGQv523UDB4HGC2G';
const SLUG = 'manuscript-disclosure-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'c7d05276-30ad-420c-9fa4-419b141a2e0a';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
