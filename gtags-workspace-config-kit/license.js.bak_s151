...
const BUY_URL = 'https://buy.polar.sh/polar_cl_uobf0e1SXkBfCizSA6fpj4XMwWyXUKrY35d1P2SmCPE';
const SLUG = 'gtags-workspace-config-kit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '9ae88dce-5044-4313-b5d5-d990d51b34bf';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
