...
const BUY_URL = 'https://buy.polar.sh/polar_cl_nMZKqKc9hEPjEMnLnQc3TlRqvBfIw1CONRJxu4LGBGp';
const SLUG = 'rechnung-pflichtangaben-lint-de';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '12b8f497-dacb-47fb-b6ad-780308d00c0b';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
