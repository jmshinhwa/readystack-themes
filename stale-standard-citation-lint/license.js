...
const BUY_URL = 'https://buy.polar.sh/polar_cl_lZ2JdS7O5rPdmN3N6ye2tuNlTTQtVEDtQVU3l1R2Q9f';
const SLUG = 'stale-standard-citation-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'a41b6ad5-3d71-4317-8964-b7a9ad5ff774';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
