...
const BUY_URL = 'https://buy.polar.sh/polar_cl_zIkhgslGAKC7DwM9YZoNxdZy6f9YhUR5XrlPP4UKzK6';
const SLUG = 'tfstate-secret-leak-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '251f824e-721e-4ebc-aafc-bb40bbbf5883';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
