...
const BUY_URL = 'https://buy.polar.sh/polar_cl_7CPHXouwL4TOLFSh30h3VBqFBoIpKPBtY3n9I1d5I7p';
const SLUG = 'saft-pt-atcud-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'c93c15ab-974c-4cca-9c09-dc088e974f8f';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
