...
var PYUPREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = PYUPREPORT;
else window.PYUPREPORT = PYUPREPORT;
