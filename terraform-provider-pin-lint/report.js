...
var TFPINREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = TFPINREPORT;
else window.TFPINREPORT = TFPINREPORT;
