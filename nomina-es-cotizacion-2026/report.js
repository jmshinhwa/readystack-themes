...
var NOMINAREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = NOMINAREPORT;
else window.NOMINAREPORT = NOMINAREPORT;
