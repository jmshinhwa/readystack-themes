...
const BUY_URL = 'https://buy.polar.sh/polar_cl_wzKKiGELabjwZgIKC7wl7uINCXdVkTvVTPu2e20gq4d';
const SLUG = 'ada-title-ii-deadline-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '5954f34c-45c5-4814-9be0-7dfc7ecc221c';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
