...
const BUY_URL = 'https://buy.polar.sh/polar_cl_Tdqu9vdxrn87T5MbFarHA1yN9HyELld2UyIeh3uK2Xp';
const SLUG = 'payroll-rate-expiry-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'bccbbc8f-3e7d-4f1f-9d84-d58db85260ee';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
