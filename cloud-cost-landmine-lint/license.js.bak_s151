...
const BUY_URL = 'https://buy.polar.sh/polar_cl_Ia8TdkkJhasNMqHS8HGMSeb7xmNWI6NKp02Mt3Fj1JG';
const SLUG = 'cloud-cost-landmine-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'c33a8b83-40b8-4ec0-95b4-f270ab26f682';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
