...
const BUY_URL = 'https://buy.polar.sh/polar_cl_KCrTfoF5x1HdHBSeZ3leRSthm5ZGowlYQNOgE2VIwVT';
const SLUG = 'svg-asset-compliance-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '5f819fa3-c2d8-464f-ba9f-3d2ea092babf';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
