...
const BUY_URL = 'https://buy.polar.sh/polar_cl_HPayV45meyb7kv9EsjIQWbwGYX2LdSe0UeuJf3cB4Py';
const SLUG = 'myinvois-field-check';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'f155a7e7-37b5-4f9f-baab-fabbbccad1ce';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
