...
const BUY_URL = 'https://buy.polar.sh/polar_cl_GLS2NunfF1vyIe7l2lyyErVSUzDSWPxuCzqQg13lMym';
const SLUG = 'consent-audit-eu';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'e9c318a9-cad6-4d64-a952-0493a67893c6';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
