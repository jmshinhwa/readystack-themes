...
const BUY_URL = 'https://buy.polar.sh/polar_cl_PbxZExBs6K4BWXLWRiNqstjycrNkQMta73SVR0uLgUy';
const SLUG = 'impressum-lint-de';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '59dd3a3d-f348-4d1d-b0a3-ac77b38757ba';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
