...
async function checkWorkspace(ctx) {
  ...
  if (!inTrial) {
    ...
    S.need_key = (last && last.files ? ('Your trial sweep covered ' + last.files + ' files and found ' + last.findings + ' findings. ') : '') + 'The workspace sweep and the written report are the paid part of ' + S.title + ' — $29 once, one licence key per person or CI seat, 7-day refund. Enter your licence key, or get one. $29 once, one licence key per person or team seat, 7-day full refund - outside technology counsel bills roughly $350-600 an hour for the same review.';
