...
const BUY_URL = 'https://buy.polar.sh/polar_cl_afnAFHpBatzPOX0Juw1NBd0sBcQU2K7p6IwUF0MYaZ8';
const SLUG = 'hmrc-fraud-prevention-header-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '1b9686b1-5679-4753-92a7-6e9c18289d01';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
