...
const BUY_URL = 'https://buy.polar.sh/polar_cl_3sT3yfbcvDeUqU9OGoDzD5kmKPNB4Y9eHCpb40stbtj';
const SLUG = 'pci-payment-page-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '45e1ee96-01ce-45ee-b1e1-0875cd2d70f6';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
