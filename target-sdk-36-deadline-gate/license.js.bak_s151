...
const BUY_URL = 'https://buy.polar.sh/polar_cl_bQ40CDRlNz5095fX0HFbdKs4DcQkqwEFoTsAd39uSTj';
const SLUG = 'target-sdk-36-deadline-gate';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '791ddb9f-d67b-46e1-9414-b9bd9a848875';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
