...
const BUY_URL = 'https://buy.polar.sh/polar_cl_XCrmjhZWtrYL52PyB4bFpa56M9QOjPckoP0Jd1Niz9b';
const SLUG = 'actions-expiry-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'dc6ef567-262d-4724-bd50-cfdf08ff58c3';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
