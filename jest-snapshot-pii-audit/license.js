...
const BUY_URL = 'https://buy.polar.sh/polar_cl_y4LAdYzCMCP3Q2C9fJwDLRnlRT3tcPnMekwHv0Dfyxw';
const SLUG = 'jest-snapshot-pii-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'f52f9da4-5159-45c1-a021-cd8ef70c7280';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
