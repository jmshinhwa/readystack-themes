...
const BUY_URL = 'https://buy.polar.sh/polar_cl_XnIBbB3OOxJvBZzwfTVMAXlVioJOa0NkXvD4m19BllB';
const SLUG = 'verrechnungspreis-doku-check';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'f8d69273-71a3-4efd-b12f-149eef583231';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
