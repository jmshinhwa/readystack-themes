...
const BUY_URL = 'https://buy.polar.sh/polar_cl_n1yAdUns90LigSNtiTVNHsN94ZnF5xmr1YbQx0YT726';
const SLUG = 'consent-gate-html-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'b89831a6-d6be-43bc-8591-d9c3fc59a793';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
