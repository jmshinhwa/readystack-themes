...
const BUY_URL = 'https://buy.polar.sh/polar_cl_Q5sXD7c9oqRLoEPaJWOpB8gz9waQqKebymb4y36LpKx';
const SLUG = 'nis2-incident-runbook-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '107ac3f6-63ff-4cff-8f8f-6e9174587449';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
