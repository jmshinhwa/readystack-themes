...
const BUY_URL = 'https://buy.polar.sh/polar_cl_n48nKSGuBUvKyot5tlEi3ACu4uVv6EJrVAOvB2JgLDv';
const SLUG = 'ai-model-license-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '4bb66fea-868b-4838-9634-32da8f8f0093';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
