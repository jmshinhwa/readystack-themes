...
const BUY_URL = 'https://buy.polar.sh/polar_cl_e8Qb9idojU90cbyA5zq0zEDev1Nm3bSKAsdth3PnbVO';
const SLUG = 'streitbeilegung-hinweis-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'c682a3f9-ac48-4154-8988-d5a2843e7239';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
