...
const BUY_URL = 'https://buy.polar.sh/polar_cl_AXdOwFfCpfVvVll4ES6gxWalyzsGaQkEtrdxl1pK46t';
const SLUG = 'freelance-act-order-lint-jp';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '0b275757-eb97-45d8-9a45-c8c2b001c74f';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
