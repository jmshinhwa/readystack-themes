...
var PAYRATE_REPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = PAYRATE_REPORT;
else window.PAYRATE_REPORT = PAYRATE_REPORT;
