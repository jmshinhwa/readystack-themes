...
var OSCALSSPREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = OSCALSSPREPORT;
else window.OSCALSSPREPORT = OSCALSSPREPORT;
