...
const BUY_URL = 'https://buy.polar.sh/polar_cl_rSz0yDSxN0wNzfxbbg7AsA7XPlBvfDqRkQ1OC3mWf2r';
const SLUG = 'auditor-ibs-cbs-nfe';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'ad7b9b1d-5f97-424d-be27-5a44ecca1122';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
