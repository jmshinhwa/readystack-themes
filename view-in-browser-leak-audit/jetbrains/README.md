# View in Browser — Publish Leak Audit (HTML) — JetBrains plugin source

The IntelliJ Platform plugin for **View in Browser — Publish Leak Audit (HTML)** (right-click in the editor or Tools → "Check This File").
