...
const BUY_URL = 'https://buy.polar.sh/polar_cl_NLG690BJU22qAXNWaQROOaDLw4Mg1DA9xifr10uIElw';
const SLUG = 'log-pii-telemetry-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '6c6e1adc-abd7-467e-9716-b97d99a1f63c';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
