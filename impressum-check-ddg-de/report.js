...
var IMPRESSUMREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = IMPRESSUMREPORT;
else window.IMPRESSUMREPORT = IMPRESSUMREPORT;
