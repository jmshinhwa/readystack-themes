...
const BUY_URL = 'https://buy.polar.sh/polar_cl_gyOsuR4TciVB1eezarZh5whJXfxrUOu4SDZCZ2hu1dw';
const SLUG = 'play-release-blocker-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'dc0e0bc5-44b5-44b2-88bb-59245d7fc10d';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
