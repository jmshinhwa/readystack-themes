...
const BUY_URL = 'https://buy.polar.sh/polar_cl_ieU1JOhfGP0Y24v6af3jxKXDGUxJw8t2Jxmau2pvwGn';
const SLUG = 'csaf-advisory-check-cra-2026';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '89c3e6a0-036c-4cc9-ba9e-8b306e1693fd';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
