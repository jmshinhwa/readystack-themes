...
const BUY_URL = 'https://buy.polar.sh/polar_cl_JaA2n3akb6IlUIK0HRJCMrQCqJKruNoyMyBg00yLQZj';
const SLUG = 'workflow-expiry-check';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '4d51a9ae-a5d3-45ce-89e0-fa21014dd87e';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
