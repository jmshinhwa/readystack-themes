...
const BUY_URL = 'https://buy.polar.sh/polar_cl_2wSKxziqGHTfu7JassC9u93PIE4YL8ThOikL64MVZVc';
const SLUG = 'angular-removed-api-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '33b198e6-828b-4be2-8384-2a49ebc92c6d';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
