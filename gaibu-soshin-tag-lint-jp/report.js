...
var GSTLREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = GSTLREPORT;
else window.GSTLREPORT = GSTLREPORT;
