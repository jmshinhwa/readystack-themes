...
const BUY_URL = 'https://buy.polar.sh/polar_cl_swHA4hMj6MekPR1NJiBDnHzv3WHxuyGOWy04M1oYI2K';
const SLUG = 'webfont-license-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'ecd3bf7a-11e5-4eb7-b2e2-28377418a830';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
