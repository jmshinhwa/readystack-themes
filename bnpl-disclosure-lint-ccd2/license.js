...
const BUY_URL = 'https://buy.polar.sh/polar_cl_JnseGCHTAOcZ0AlitWyDYryhIwPKIvR6ZdDWi3IEOsc';
const SLUG = 'bnpl-disclosure-lint-ccd2';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '6d4364b0-ddf6-443b-915d-8a170aab09e1';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
