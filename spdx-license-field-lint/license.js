...
const BUY_URL = 'https://buy.polar.sh/polar_cl_2aVJUYKnFr7h6WfPcOmXd27R9KXw2jEpdVXJc4G6fJk';
const SLUG = 'spdx-license-field-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '2286bcca-1f02-4fb1-bbcc-63e1b691e5b3';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
