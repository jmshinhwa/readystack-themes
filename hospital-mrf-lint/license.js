...
const BUY_URL = 'https://buy.polar.sh/polar_cl_EYHXk1sWaTjLs6NqYbuSokElCWuL5qJY62gtI1a91Ah';
const SLUG = 'hospital-mrf-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'd1e0af72-8d51-4ba0-a129-108e46e585d0';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
