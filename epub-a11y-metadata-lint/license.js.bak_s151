...
const BUY_URL = 'https://buy.polar.sh/polar_cl_oPMAjVdCsJ3pQdXfabWNj50DOpyh2wFYTMd6w11o7Aj';
const SLUG = 'epub-a11y-metadata-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '8765c2fb-1a53-4948-8eef-dd975a458ed3';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
