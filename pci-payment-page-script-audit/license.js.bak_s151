...
const BUY_URL = 'https://buy.polar.sh/polar_cl_FKoJOcDSLKquM3gnPEkdjzJ89osFHC7TgbEej21i5FQ';
const SLUG = 'pci-payment-page-script-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '1ce7db7e-5cd2-493a-acee-7148bd92f866';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
