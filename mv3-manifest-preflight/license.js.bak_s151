...
const BUY_URL = 'https://buy.polar.sh/polar_cl_aFiEEPOG6L3s1pwKF9RowcLZUa5oviTpQU4QK3fYdcU';
const SLUG = 'mv3-manifest-preflight';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '04d7f956-ad38-49a7-86dd-ac6ea5caffe3';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
