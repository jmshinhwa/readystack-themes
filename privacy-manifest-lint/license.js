...
const BUY_URL = 'https://buy.polar.sh/polar_cl_FqPgaCWDs6XopadWNiuJdDK0t434XmIx9iHsw1X3dFZ';
const SLUG = 'privacy-manifest-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'c91f07aa-6b3a-4c49-8d32-c70684f8dd1c';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
