...
var SAFTREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = SAFTREPORT;
else window.SAFTREPORT = SAFTREPORT;
