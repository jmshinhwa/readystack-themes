...
var AGEGATE_REPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = AGEGATE_REPORT;
else window.AGEGATE_REPORT = AGEGATE_REPORT;
