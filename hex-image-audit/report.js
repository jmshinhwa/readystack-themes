...
var HEXREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = HEXREPORT;
else window.HEXREPORT = HEXREPORT;
