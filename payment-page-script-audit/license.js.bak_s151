...
const BUY_URL = 'https://buy.polar.sh/polar_cl_3JweRl77lj7Lnb2RWmPjP2DpCF71WE5AcU4xO1lrAFh';
const SLUG = 'payment-page-script-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '64cd4931-9b74-4bd6-bc1c-3b2a99542a5d';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
