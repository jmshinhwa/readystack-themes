...
const BUY_URL = 'https://buy.polar.sh/polar_cl_SVODVnUURCH7VHX6rC7LOLjYQHTufrBEMAij42QNLnC';
const SLUG = 'maui-ios-submission-gate';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'dadf268b-9fec-4d50-96ce-2cd194383488';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
