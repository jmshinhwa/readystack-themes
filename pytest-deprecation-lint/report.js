...
var PYTESTDEPREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = PYTESTDEPREPORT;
else window.PYTESTDEPREPORT = PYTESTDEPREPORT;
