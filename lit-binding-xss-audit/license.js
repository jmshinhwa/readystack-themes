...
const BUY_URL = 'https://buy.polar.sh/polar_cl_rQuve6vrYJ7scHEYwBnxBPid2txKeXvLSITuq0H0N0t';
const SLUG = 'lit-binding-xss-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '9f1110bd-8b78-45bc-9498-6932d8a24b3e';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
