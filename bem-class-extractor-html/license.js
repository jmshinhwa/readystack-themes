...
const BUY_URL = 'https://buy.polar.sh/polar_cl_KpshZaXMI3nFFxkyC13chl0cdxza8558hpEYP2ERbwy';
const SLUG = 'bem-class-extractor-html';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '1bdafd2f-b09f-44df-b9f5-495442543297';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
