...
const BUY_URL = 'https://buy.polar.sh/polar_cl_vmmhH1xBuIiTeyI1tTLXEkFDotprl8ilIxhtd2l5ESK';
const SLUG = 'otel-collector-drift-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '1e978fea-9d5e-42a2-823d-b0c307b2a8f9';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
