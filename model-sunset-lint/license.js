...
const BUY_URL = 'https://buy.polar.sh/polar_cl_L419KriWzJmPVgpnUDLnm67jUqWfQGdXNRqW43yeENB';
const SLUG = 'model-sunset-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '9fabb408-48a0-4456-8a7b-6c464c6adb51';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
