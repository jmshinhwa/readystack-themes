...
var MCPGUARD_REPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = MCPGUARD_REPORT;
else window.MCPGUARD_REPORT = MCPGUARD_REPORT;
