...
const BUY_URL = 'https://buy.polar.sh/polar_cl_epxwtDOEi755l0QccdiNVxz4eMRN1LpYpjwUG0YyguW';
const SLUG = 'terraform-provider-pin-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '05491f7e-2dee-4a5a-a264-c4aa0ced89cb';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
