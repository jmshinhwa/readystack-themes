...
const BUY_URL = 'https://buy.polar.sh/polar_cl_isVXdaMI7ZlmmjzagEfs13ZoOJs3Y1ctvxmYt22iEPr';
const SLUG = 'cra-readiness-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '0435ee62-6d3c-4bd5-bcd2-139011c19a21';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
