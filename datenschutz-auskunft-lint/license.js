...
const BUY_URL = 'https://buy.polar.sh/polar_cl_L1T6oCyVJvmCPSj0Gs7SN6KRhS2VcgbkcA1KQ1oguQG';
const SLUG = 'datenschutz-auskunft-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'eb66565f-da66-4934-8edb-ddc4991d6ccb';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
