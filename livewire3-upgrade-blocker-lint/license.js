...
const BUY_URL = 'https://buy.polar.sh/polar_cl_JoEBGmMxghz3XsayVbZSJktcNspzSxRkJYcdc3S0eYU';
const SLUG = 'livewire3-upgrade-blocker-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'fe36b196-d6ca-4af6-b5e9-6ac7b7336b3c';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
