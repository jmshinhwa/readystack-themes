...
const BUY_URL = 'https://buy.polar.sh/polar_cl_CeX6hwvCZRApL28KFlpqWeqOIttcxlAsNaLxA23WFNT';
const SLUG = 'livewire-client-surface-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'f75663e9-1423-40eb-a454-0495e816afb8';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
