...
const BUY_URL = 'https://buy.polar.sh/polar_cl_GknOiuCJgINiCOFYgKw1rgbS8bdYvuQ2meGB82nNkkS';
const SLUG = 'age-gate-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'fc39b4c7-311f-4d95-b764-ab1795eb6882';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
