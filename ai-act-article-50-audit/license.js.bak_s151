...
const BUY_URL = 'https://buy.polar.sh/polar_cl_CgFfcIlACJrXuIyrkoDLS0KZVtswtVmyEUoIm4c4Fhc';
const SLUG = 'ai-act-article-50-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'ac23197a-ad0f-4e22-b1a1-e258cabd96e5';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
