...
const BUY_URL = 'https://buy.polar.sh/polar_cl_IRIM55duZnXhnBKcaSt0lxXKfo7qDs2TijKjG31kMtF';
const SLUG = 'workflow-break-date-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'eeae2294-e236-4145-9695-fec9251ec482';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
