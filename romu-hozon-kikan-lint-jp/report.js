...
var HOZONREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = HOZONREPORT;
else window.HOZONREPORT = HOZONREPORT;
