...
const BUY_URL = 'https://buy.polar.sh/polar_cl_r0AsPdmaipunFUfn7RJOfQAdEdFXC397cXwZu01Rmw7';
const SLUG = 'npm-trusted-publish-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '41bdb552-fc29-4ab4-a33e-4d66a3e3bccc';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
