...
const BUY_URL = 'https://buy.polar.sh/polar_cl_9L57rNpRm9rHntAhalWjzrWXftaA8sLKSAxkv2n1SKA';
const SLUG = 'mcp-config-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '2ac9cda7-a5cd-4957-8fcc-6c6ee2b827ab';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
