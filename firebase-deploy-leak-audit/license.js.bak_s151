...
const BUY_URL = 'https://buy.polar.sh/polar_cl_s056vzYWEEtw0Muvdls6QOXpqf47Huzm8zNrC3JL2Ya';
const SLUG = 'firebase-deploy-leak-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '6bfee5a3-5b4d-47fa-a94d-7130a0293e36';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
