...
const BUY_URL = 'https://buy.polar.sh/polar_cl_Lc28mhKuKp4eH5tAgxzJQMaxWtH5MmoVxlIvk03slmO';
const SLUG = 'crypto-export-notice-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '8cdae8c1-9233-4406-845b-89a78bea1c6b';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
