...
const BUY_URL = 'https://buy.polar.sh/polar_cl_0qIqdKq149OPf1mvGZKukzSvyH1nK9fHwub4l4P27pr';
const SLUG = 'vsix-publish-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '77b1101f-42ea-4ded-8945-df30e5455ef5';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
