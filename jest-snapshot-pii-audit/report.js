...
var JSPIIREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = JSPIIREPORT;
else window.JSPIIREPORT = JSPIIREPORT;
