...
const BUY_URL = 'https://buy.polar.sh/polar_cl_CFCuxNMjv5zsartvO10MlY2XKN142StTkIxHL43Dlqa';
const SLUG = 'devicetree-config-language-pack';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'abd99b67-8ddf-4fcb-b797-a50d4438728d';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
