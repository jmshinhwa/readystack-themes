...
const BUY_URL = 'https://buy.polar.sh/polar_cl_XWEOA6J245vtVZGR660GkeoZbO1MW3g23VZSp3goB02';
const SLUG = 'erb-escape-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '9e0bf333-fac0-4db6-b79f-02a382c311fd';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
