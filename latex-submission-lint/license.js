...
const BUY_URL = 'https://buy.polar.sh/polar_cl_uLmgCBAZSFSJQ8Yvoose6IUOjSzo0hTMNwRg221VgCt';
const SLUG = 'latex-submission-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'b8d25493-257a-42d0-9535-e0ab110252a1';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
