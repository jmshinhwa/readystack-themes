...
const BUY_URL = 'https://buy.polar.sh/polar_cl_aNRhjxJUQvfo4XkkVInz22Vk3dZYMt8tpZyj14a3Wmz';
const SLUG = 'coverage-gate-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '596e6e6a-1103-49cd-981a-4689059cf015';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
