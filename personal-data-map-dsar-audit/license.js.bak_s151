...
const BUY_URL = 'https://buy.polar.sh/polar_cl_BXPHG1fr7NIyCwKd6UwVuUit0HVpNLllIqENN46kmIz';
const SLUG = 'personal-data-map-dsar-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '1c16a5d8-4fc0-47c0-a0fb-bda02e6dbc88';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
