...
const BUY_URL = 'https://buy.polar.sh/polar_cl_cvvpOHUl0trDgV1H4FITDdGO0eTfT4jX9Olem3MhKMp';
const SLUG = 'dsa-terms-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'e75a95c1-0515-4821-acc2-d70f5486ab52';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
