...
const BUY_URL = 'https://buy.polar.sh/polar_cl_0EI3dcWH2UgJOSuTbAEdRrIUxrnBcdXX6Sa2T2EJ5og';
const SLUG = 'cloud-manifest-audit-kit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '6b97b0b2-dacc-49e9-879b-92d95071a075';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
