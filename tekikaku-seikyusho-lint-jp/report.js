...
var INVREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = INVREPORT;
else window.INVREPORT = INVREPORT;
