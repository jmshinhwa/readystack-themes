...
const BUY_URL = 'https://buy.polar.sh/polar_cl_FgqChyU4dcdTz5VWg1S6cM0Taaa73QIq6oV5K0CFWfa';
const SLUG = 'actions-deprecation-lint-2026';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'c0762fa7-455d-4c9c-afa4-82492e564c66';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
