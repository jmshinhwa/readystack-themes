...
const BUY_URL = 'https://buy.polar.sh/polar_cl_VdJFkandoGUUByeiL7DUCOlNFG2V3zUlBrgjG3pGukg';
const SLUG = 'vergabe-schwellenwerte-check-2026';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '7d448973-66ab-4acd-8cb0-067615acc061';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
