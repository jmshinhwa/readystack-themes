...
var KSEFREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = KSEFREPORT;
else window.KSEFREPORT = KSEFREPORT;
