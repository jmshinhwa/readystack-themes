...
const S = {
  title: 'PCI DSS 6.4.3 Payment Script Lint',
  need_key: 'Full version: sweep every checkout template in the workspace and write the dated 6.4.3 script inventory report you hand the assessor. $29 once \u00b7 one licence key per person or team seat \u00b7 PCI consultants and QSAs typically bill $150-$300 an hour for the same payment-page script review.',
...
const GLOB = '**/*.{html,htm,php,twig,liquid,ejs}';
...
function activate(ctx) {
  ...
  try { require('./auto.js').start(ctx, { vscode: vscode, ENGINE: ENGINE, GLOB: GLOB, PREFIX: PREFIX, title: S.title, slug: 'pci-payment-script-lint', price: 29 }); } catch (e) {}
}
