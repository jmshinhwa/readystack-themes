...
const BUY_URL = 'https://buy.polar.sh/polar_cl_PYeBtgpLFmY3auUggxB51fD2oYJqmKGpsnB0D3InP45';
const SLUG = 'cert-lifetime-lint-47day';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '1bbd6d54-a9a2-4f8f-bb0a-ddb3381e690e';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
