...
const BUY_URL = 'https://buy.polar.sh/polar_cl_S4Q2ATU1yHnb0CDupM8ykagoorbx7NrWOZ6XY0QFsxj';
const SLUG = 'wcag-clause-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '90be2e0b-c5b0-4463-a09d-6d5e63b79887';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
