...
const BUY_URL = 'https://buy.polar.sh/polar_cl_8JI95U8rbDCUA7ICnp4TnHvZiEgAlSlU1SW8O0S5lT3';
const SLUG = 'auslandsbeteiligung-meldepflicht-check';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '39b32dd8-00ad-47a2-b2a5-d411d6730afb';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
