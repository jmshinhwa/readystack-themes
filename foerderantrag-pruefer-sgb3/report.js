...
var FOERDERREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = FOERDERREPORT;
else window.FOERDERREPORT = FOERDERREPORT;
