...
const BUY_URL = 'https://buy.polar.sh/polar_cl_WKA2GllrJspsrScNLUGtqn4DgnIEsTN1FpAtT42RfQY';
const SLUG = 'cert-lifetime-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'ef1a1b35-9533-4833-9aca-02777b305525';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
