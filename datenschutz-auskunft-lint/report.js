...
var AUSKUNFTREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = AUSKUNFTREPORT;
else window.AUSKUNFTREPORT = AUSKUNFTREPORT;
