...
const BUY_URL = 'https://buy.polar.sh/polar_cl_wQKx0P8uMksFUK1UmWN0Eq0cVxQNxuPlCLzaw3eXDlW';
const SLUG = 'coppa-notice-lint-2026';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'f3582ba0-cbad-4544-a1f0-deb424f5d630';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
