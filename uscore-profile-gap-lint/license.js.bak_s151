...
const BUY_URL = 'https://buy.polar.sh/polar_cl_hiGlxcgqsijQYOSCbWd96m5roAeXS4jd5pGkt0elCAc';
const SLUG = 'uscore-profile-gap-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '72eabcd2-9508-43a7-bc46-5ebff2873a10';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
