...
const BUY_URL = 'https://buy.polar.sh/polar_cl_GWWqGdsgkMU8DtX6kLrbb3vtkdLTWkz82XqUr09YevL';
const SLUG = 'tdm-reservation-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '034001f8-e627-4bfc-b532-c6350907391c';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
