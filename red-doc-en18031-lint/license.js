...
const BUY_URL = 'https://buy.polar.sh/polar_cl_5Hm0xLe0JD2dW7YPmdtuS5sX86RiELo7TMeUJ2zEQQr';
const SLUG = 'red-doc-en18031-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'abec65a8-e496-4180-b5e6-0badbbb06196';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
