...
const BUY_URL = 'https://buy.polar.sh/polar_cl_SbAs69NIkhPJABSgWl4Gx0cx54SRPDVWL5mHL3Tg52Q';
const SLUG = 'renpy-release-gate';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '19fb31d0-c6a6-49fa-8a8c-9fabfe8dabca';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
