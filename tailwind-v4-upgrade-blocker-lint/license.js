...
const BUY_URL = 'https://buy.polar.sh/polar_cl_DrserQC4j0BJaLfZGKeBYaHfWMTN82kebNp3d4R629n';
const SLUG = 'tailwind-v4-upgrade-blocker-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'eaec28ab-50a6-47f1-8c70-7c8e32cb084b';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
