...
const BUY_URL = 'https://buy.polar.sh/polar_cl_kCkjoK6RSzXqKIBmn640vXFJDzu9LNv9AOxLs1ByYcR';
const SLUG = 'eu-health-claim-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '916e44da-6a02-4923-a2a7-c2d815e1a71a';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
