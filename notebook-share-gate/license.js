...
const BUY_URL = 'https://buy.polar.sh/polar_cl_UD1n6ljLUOrZtnOT9UfRLSi9NjUk6UvFwZB0a0Zgads';
const SLUG = 'notebook-share-gate';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'b0dcdc65-5f28-46bb-b2be-407f50a04784';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
