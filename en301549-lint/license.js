...
const BUY_URL = 'https://buy.polar.sh/polar_cl_9o33w7ZEWFvtHnsjAVCGBPT5ubS1CZsHl7iec0wNhUa';
const SLUG = 'en301549-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '3feb4b57-d0b9-4cde-ae80-ec6a51ab66a9';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
