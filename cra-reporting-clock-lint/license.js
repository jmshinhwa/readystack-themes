...
const BUY_URL = 'https://buy.polar.sh/polar_cl_GgC3uLMfpdK3CNNCQPU9Fzqj26FymQcDCi9d74XQFG5';
const SLUG = 'cra-reporting-clock-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '4c81ffef-11c1-4867-aad7-6e321c6d5799';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
