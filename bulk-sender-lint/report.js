...
var BULKREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = BULKREPORT;
else window.BULKREPORT = BULKREPORT;
