...
var PGMLREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = PGMLREPORT;
else window.PGMLREPORT = PGMLREPORT;
