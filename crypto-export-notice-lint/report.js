...
var XEXPORTREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = XEXPORTREPORT;
else window.XEXPORTREPORT = XEXPORTREPORT;
