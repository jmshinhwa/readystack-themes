...
const BUY_URL = 'https://buy.polar.sh/polar_cl_FK2aTsDAbD2vrqDReGURvm8s8Tn3njdfFsaw925mpn8';
const SLUG = 'ai-companion-safety-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'c4bcc242-60fa-4955-8df6-f273a59a214c';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
