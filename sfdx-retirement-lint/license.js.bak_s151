...
const BUY_URL = 'https://buy.polar.sh/polar_cl_SFrevid2aV0vMegeiuuJ5c1n6mtsHt2zeUpb041va0r';
const SLUG = 'sfdx-retirement-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'c3a2f995-a5e2-4a55-9b3d-e53fd39c8598';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
