...
const BUY_URL = 'https://buy.polar.sh/polar_cl_HaD7JBRbjXRom3teYfngHxChxktOPKNtnKb6H0Vp7Cp';
const SLUG = 'erb-rails-view-snippets-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '9c3d26a4-6682-47e8-84c4-a92d95fe39db';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
