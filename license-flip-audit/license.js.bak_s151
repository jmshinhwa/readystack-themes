...
const BUY_URL = 'https://buy.polar.sh/polar_cl_sFzJiUXy6pSbEx0SFN1aIg7vRguyRc32MpDnb1iCHPe';
const SLUG = 'license-flip-audit';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '90acae89-d56e-45a9-8fb6-c107af1a2a5f';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
