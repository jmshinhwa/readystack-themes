...
var SWIFT6REPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = SWIFT6REPORT;
else window.SWIFT6REPORT = SWIFT6REPORT;
