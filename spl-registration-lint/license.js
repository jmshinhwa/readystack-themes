...
const BUY_URL = 'https://buy.polar.sh/polar_cl_5DGxPviszTwjOqxMnoZEuBHdaWberjjix1mAZ1mQljU';
const SLUG = 'spl-registration-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'eb78306f-3900-4bd8-8f71-1a1a544c4d3b';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
