...
const BUY_URL = 'https://buy.polar.sh/polar_cl_g3Qr7cMfa08KRBcujOSVMVHGnBL70yNLs0MuA0ijHo7';
const SLUG = 'firestore-rules-guard';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'bfcb61b8-c58c-4479-b09a-1477a366fdb0';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
