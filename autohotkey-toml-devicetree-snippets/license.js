...
const BUY_URL = 'https://buy.polar.sh/polar_cl_FWKDlpMmDW5CMSZxln7XEJnFClvFbQRZiuCsA0NNT9v';
const SLUG = 'autohotkey-toml-devicetree-snippets';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'de5ebf8e-876a-4064-af2d-bc57e5d817ba';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
