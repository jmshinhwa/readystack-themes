...
var AICSREPORT = { escapeHtml: escapeHtml, summaryLine: summaryLine, toText: toText, toHtml: toHtml };
if (typeof module !== 'undefined' && module.exports) module.exports = AICSREPORT;
else window.AICSREPORT = AICSREPORT;
