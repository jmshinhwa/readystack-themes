...
const BUY_URL = 'https://buy.polar.sh/polar_cl_PQWEmhUFLQJSTpOot3FMujKCDC8ALMzB8eBRl2DyIVx';
const SLUG = 'data-act-switching-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = '540278a1-c0ac-4abe-8b02-59e78e4a8b2f';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
