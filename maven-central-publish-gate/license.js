...
const BUY_URL = 'https://buy.polar.sh/polar_cl_1ApNFZVJP2ES4VPRlkdZLHqQgk44gcmW4aENZ48tDsD';
const SLUG = 'maven-central-publish-gate';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'abc94d9a-2e82-4572-9504-eecb752ce7a7';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
