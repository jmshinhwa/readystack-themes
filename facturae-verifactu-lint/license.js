...
const BUY_URL = 'https://buy.polar.sh/polar_cl_OsiUcPT9Hbx1kJ35oWK3KjwcKxIRMfjV7HP581OIf8N';
const SLUG = 'facturae-verifactu-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'd2ec7898-9a9e-48a3-b591-67e21d4e0442';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
