...
const BUY_URL = 'https://buy.polar.sh/polar_cl_0zZyRdFLtRxDC42FwytNvrE9IKgRLFcSm8ED044gS16';
const SLUG = 'outlook-email-html-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'f6489dba-8564-42e7-84b8-e5e250ba4a0f';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
