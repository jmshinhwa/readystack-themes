...
const BUY_URL = 'https://buy.polar.sh/polar_cl_nBmXM2HwLUh5BD7yp7KsyvTpkpyGWebhEowU21LBIbE';
const SLUG = 'pci-payment-page-script-lint';   // s151 — 키 판 핑의 익명 이름 (vsix_build._license_js 가 찍는다)
const BENEFIT_ID = 'd59cc04d-0f16-4718-9443-f3e584db9a8a';   // s140 — 이 상품의 benefit. till.py 가 찍는다 · validate 가 이걸로 묻는다 (⛔조직만 물으면 키 하나로 전부 열린다)
